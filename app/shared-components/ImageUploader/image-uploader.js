...
ImageUploader.propTypes = {
    ...
    initialImage: React.PropTypes.shape(),
    uploadButtonStyle: React.PropTypes.shape(),
    clearImageButtonStyle: React.PropTypes.shape(),
    imageStyle: React.PropTypes.shape(),
    errorStyle: React.PropTypes.shape(),
    emptyContainerStyle: React.PropTypes.shape()
};
