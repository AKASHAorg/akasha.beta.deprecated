...
transactionsDB.pending.hook('creating', (primaryKey, obj) => {
    dbg('creating pending.. ', obj);
});
transactionsDB.pending.hook('updating', (primaryKey, obj) => {
    dbg('updating pending.. ', obj);
});
transactionsDB.mined.hook('creating', (primaryKey, obj) => {
    dbg('creating mined.. ', obj);
});
transactionsDB.mined.hook('updating', (primaryKey, obj) => {
