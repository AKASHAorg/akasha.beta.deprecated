...
export const dashboardAddColumnSuccess = data => action(types.DASHBOARD_ADD_COLUMN_SUCCESS, { data });
...
export const dashboardDelete = id => action(types.DASHBOARD_DELETE, { id });
...
export const dashboardDeleteSuccess = data => action(types.DASHBOARD_DELETE_SUCCESS, { data });
export const dashboardDeleteColumn = columnId => action(types.DASHBOARD_DELETE_COLUMN, { columnId });
...
export const dashboardDeleteColumnSuccess = data => action(types.DASHBOARD_DELETE_COLUMN_SUCCESS, { data });

export const dashboardDeleteNewColumn = () => action(types.DASHBOARD_DELETE_NEW_COLUMN);

export const dashboardGetActive = payload => action(types.DASHBOARD_GET_ACTIVE, payload);
...
export const dashboardGetActiveSuccess = data => action(types.DASHBOARD_GET_ACTIVE_SUCCESS, { data });

export const dashboardGetAll = payload => action(types.DASHBOARD_GET_ALL, payload);
...
export const dashboardSetActiveSuccess = data => action(types.DASHBOARD_SET_ACTIVE_SUCCESS, { data });
...
export const dashboardUpdateColumnSuccess = data => action(types.DASHBOARD_UPDATE_COLUMN_SUCCESS, { data });
export const dashboardUpdateNewColumn = changes => action(types.DASHBOARD_UPDATE_NEW_COLUMN, { changes });
