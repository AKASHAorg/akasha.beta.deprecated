...
export const selectProfileExists = (state /*: Object*/) => state.profileState.get('exists');

export const selectProfileInterests = (state /*: Object*/) => state.profileState.get('interests');

export const selectEssenceIterator = (state /*: Object*/) => state.profileState.get('essenceIterator');

export const selectEssenceEvents = (state /*: Object*/) => state.profileState.get('essenceEvents');

export const selectCyclingStates = (state /*: Object*/) => state.profileState.get('cyclingStates');

export const selectBalance = (state /*: Object*/) => state.profileState.get('balance');

export const selectBurnedMana = (state /*: Object*/) => state.profileState.get('manaBurned');

export const selectPublishingCost = (state /*: Object*/) => state.profileState.get('publishingCost');

export const selectLoginErrors = (state /*: Object*/) => state.profileState.get('loginErrors');

export const selectFaucet = (state /*: Object*/) => state.profileState.get('faucet');

export const selectKarmaRanking = (state /*: Object*/) => state.profileState.get('karmaRanking');

export const selectCanCreateTags = (state /*: Object*/) => state.profileState.get('canCreateTags');
