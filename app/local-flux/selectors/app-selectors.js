...
export const selectDisplayedNotifications = (state /*: Object*/) =>
    state.appState.get('displayedNotifications');
...
export const selectNavigationForwardCounter = (state /*: Object*/) =>
    state.appState.get('navigationForwardCounter');
export const selectNavigationBackCounter = (state /*: Object*/) =>
    state.appState.get('navigationBackCounter');
