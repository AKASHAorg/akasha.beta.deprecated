...
export const selectGetOptions = (state/* : Object */) => state.settingsState.get('geth');
...
export const getIpfsStoragePath = (state/* : Object */) => state.settingsState.getIn(['ipfs', 'storagePath'])
