...
export const selectClaimableFetchingEntries = (state /*: Object */) =>
    state.claimableState.get('fetchingEntries');
export const selectClaimableFetchingMoreEntries = (state /*: Object */) =>
    state.claimableState.get('fetchingMoreEntries');
