...
export const selectProfileSuggestions = (state /*: Object */) =>
    state.searchState.get('profilesAutocomplete');
...
export const selectSearchEntries = (state /*: Object */) =>
    selectEntrySearchResults(state).map((entryId /*: string */) => selectEntryById(state, { entryId }));

export const getSearchQueryPending = (state /*: Object */) => selectSearchFlags(state).get('queryPending');
export const getSearchMoreQueryPending = (state /*: Object */) =>
    selectSearchFlags(state).get('moreQueryPending');
