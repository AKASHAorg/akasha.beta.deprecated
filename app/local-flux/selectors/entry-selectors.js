...
export const selectFullEntryLatestVersion = (state/*: Object */) => state.entryState.get('fullEntryLatestVersion');
...
export const getCanClaimPendingEntry = (state/*: Object */) => selectPendingEntriesFlags(state).get('canClaimPending');
export const getFetchingEntryBalance = (state/*: Object */) => selectPendingEntriesFlags(state).get('fetchingEntryBalance');
