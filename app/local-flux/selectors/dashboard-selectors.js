...
export const getActiveDashboardColumns = createSelector(
    ...
    (activeDashboard /*: Object */, columns /*: Object */) => {
        if (activeDashboard) {
            return activeDashboard.get('columns').map(colId => columns.get(colId));
        }
        return new List();
    }
);
...
export const getAllDashboards = createSelector(
    ...
    (dashboardIds /*: List<string> */, dashboards /*: Object */) => dashboardIds.map(id => dashboards.get(id))
);
...
export const getRenamingDashboard = (state /*: Object */) =>
    selectDashboardFlags(state).get('renamingDashboard');
export const getFirstDashboardReady = (state /*: Object */) =>
    selectDashboardFlags(state).get('firstDashboardReady');
