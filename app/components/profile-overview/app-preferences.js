                ...
                <div className="app-preferences__main">
                    ...
                    <div className="app-preferences__lang">
                        ...
                        >
                            ...
                            <Option
                                value="zh-CN">{ intl.formatMessage(settingsMessages.chineseSimplified) }</Option>
                            <Option
                    ...
                    <div className="app-preferences__theme">
                        ...
                        <div className="app-preferences__theme-radio-wrap">
                            <RadioGroup onChange={ this.handleThemeChange }
                                        value={ this.state.darkTheme }>
                                <Radio
                                    value={ false }>{ intl.formatMessage(settingsMessages.lightTheme) }</Radio>
                                <Radio
                                    value>{ intl.formatMessage(settingsMessages.darkTheme) }</Radio>
                            </RadioGroup>
                        </div>
                    </div>
                </div>
