...
class ProfileSettings extends Component {
    ...
    onSaveSettings = () => {
        ...
        const {
            defaultLicenseId, defaultLicenseParent, donationsValue, hideComments,
            hideCommentsValue, hideEntries, hideEntriesValue, notifFeed, notifDonations,
            notifComments, notifVotes, unlockTime, rememberTime, trustedDomains
        } = this.state;
    ...
    render () { // eslint-disable-line complexity
        const {
            intl, licenses, loggedProfileData, pendingToggleDonations, savingUserSettings,
            userSettings
        } = this.props;
        const {
            defaultLicenseId, defaultLicenseParent, hideComments, hideCommentsValue, hideEntries,
            hideEntriesValue, notifComments, notifDonations, notifFeed, notifVotes, unlockTime,
            rememberTime, donationsValue, trustedDomains
        } = this.state;
                    ...
                    <Form>
                        ...
                        <div>
                            ...
                            <div className="profile-settings__tips">
                                ...
                                >
                                    <Radio
                                        value>{ intl.formatMessage(settingsMessages.tipsAccept) }</Radio>
                                    <Radio
                                        value={ false }>{ intl.formatMessage(settingsMessages.tipsDoNotAccept) }</Radio>
                                </RadioGroup>
                            </div>
                        </div>
                        <div>
