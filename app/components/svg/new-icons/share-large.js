...
const ShareLarge = React.forwardRef((props, ref) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" {...props} ref={ref}>
...
ShareLarge.displayName = "ShareLarge";
