...
const Tag = props => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" {...props}>
    <g fill="none" fillRule="evenodd" transform="translate(2 .47)">
      <polygon points="6.138 .858 2.633 3.259 2.633 13.372 6.154 11.045 9.724 13.365 9.724 3.256" strokeLinecap="round" strokeLinejoin="round" transform="rotate(20 6.179 7.115)" />
