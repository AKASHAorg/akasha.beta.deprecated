...
import { Icon, ProfilePopover, VotePopover, VotesModal } from '../';
...
class Comment extends Component {
        ...
        <div className="comment">
            <div className="comment__inner">
              ...
              { this.props.comment.score }
                ...
                <span className="content-link comment__retry-button"
    ...
    render () { // eslint-disable-line max-statements, complexity
        const {
            author, blockNr, comment, containerRef, children, hideCommentSettings, intl,
            isHighlighted, onReply, resolvingComment, showReplyButton, vote, votePending
        } = this.props;
                ...
                <div className={ innerClass }>
                    <div className="comment__votes">
                        <VotePopover
                            ...
                            { ...voteProps }
                        />
                        <span className="comment__score content-link"
                  ...
                  { comment.score }
                    ...
                    <div className="comment__main">
                        <div className="flex-center-y comment__header">
                            { author &&
                            <ProfilePopover ethAddress={ comment.author.ethAddress }
