...
import { dashboardMessages, formMessages, generalMessages } from '../../locale-data/messages';
    ...
    render () {
        ...
        return (
            <Modal
                ...
                footer={ [
                    <div key="dashboardModalFooterLeft"
                         className="new-dashboard-modal__footer-left">
                    </div>,
                    <div key="dashboardModalFooterRight"
                         className="new-dashboard-modal__footer-right">
