...
class ProfileCard extends Component {
    ...
    render () {
        const {
            containerRef, followPending, intl, isFollower, isPending, loggedEthAddress, profile,
            tipPending
        } = this.props;
            ...
            return (
                ...
                >
                    <div className="profile-card__details">
                        ...
                        <div
                            className="profile-card__about_placeholder profile-card__about_placeholder-2"/>
                    </div>
                </Card>
            );
        }
            ...
            >
                <div className="profile-card__details">
                    <div className="flex-center-y">
                        ...
                        >
                            <Icon className="profile-card__counter-icon profile-card__karma-icon"
                                  type="karma"/>
                        </Tooltip>
                        <div className="profile-card__counter-text">
