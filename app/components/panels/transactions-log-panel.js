                ...
                <DataLoader flag={ fetchingHistory }>
                    <Timeline>
                        { historyActions.map(action => {
                            ...
                            const iconType = action.get('success') ? 'check-circle-o' : 'close-circle-o';
                            return (
                                <Item
            ...
            <div className="transactions-log-panel__timeline-wrapper">
                <Timeline>
                    { pendingActions.map(action => (
                        <Item
                            dot={ <Icon className="transactions-log-panel__pending"
                                        type="clock-circle-o"/> }
                            key={ action.get('id') }
                        >
                            <TransactionLog
    ...
    render () {
        ...
        const pendingTab = (
            <span className="flex-center">
                ...
                <span className="flex-center transactions-log-panel__pending-count">
                    { pendingActions.size }
                </span>
            </span>
        );
