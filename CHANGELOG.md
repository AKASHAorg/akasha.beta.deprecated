...
<a name="0.5.2"></a>
## [0.5.2](https://github.com/AkashaProject/node-app/compare/v0.5.1...v0.5.2) (2017-03-09)


### Bug Fixes

* **bookmarks:** load more saved entries issue ([9342194](https://github.com/AkashaProject/node-app/commit/9342194))
* **comments actions:** fix typo => `comm` to `comment` ([d4e86c4](https://github.com/AkashaProject/node-app/commit/d4e86c4))
* **licence dialog:** fix default licence checkbox ripple ([78f2267](https://github.com/AkashaProject/node-app/commit/78f2267))
