...
exports.DEFAULT_IPFS_CONFIG = {
    ...
    Bootstrap: exports.IPFS_BOOTSTRAP_PEERS.concat(exports.AKASHA_BOOTSTRAP_PEERS).concat(exports.DEFAULT_CIRCUIT_RELAYS),
    Discovery: {
        MDNS: {
            Enabled: false,
            Interval: 10,
...
exports.generalSettings.set(exports.BASE_URL, 'https://gateway.ipfs.io/ipfs');
