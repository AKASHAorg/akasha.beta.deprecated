  ...
  const execute = Promise
    .coroutine(function* (data) {
      ...
      return {
        ...
        [symbol]: {
          total: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(totalAeth)))).toNumber(),
          free: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(free)))).toNumber(),
          bonded: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(bonded)))).toNumber(),
          cycling: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(cycling)))).toNumber(),
        },
        mana: {
          total: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(manaTotal)))).toNumber(),
          spent: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(manaSpent)))).toNumber(),
          remaining: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(manaRemaining)))).toNumber(),
        },
        karma: { total: (web3Api.instance.utils.toBN(
          fromWei(web3Api.instance.utils.toBN(karma)))).toNumber() },
        essence: {
          total: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(essence)))).toNumber(),
          aethValue: (web3Api.instance.utils.toBN(
            fromWei(web3Api.instance.utils.toBN(essenceValue)))).toNumber(),
        }
        , unit, etherBase,
      };
    });
