...
export default function init(sp, getService) {
    const execute = Promise.coroutine(function* (data, cb) {
        ...
        const partialProfile = {
            ...
            karma: (web3Api.instance.utils.toBN(web3Api.instance.utils.fromWei(web3Api.instance.utils.toBN(karma), 'ether'))).toNumber(),
            essence: (web3Api.instance.utils.toBN(web3Api.instance.utils.fromWei(web3Api.instance.utils.toBN(essence), 'ether'))).toNumber(),
        };
        cb('', partialProfile);
        if (!!unpad(hash)) {
