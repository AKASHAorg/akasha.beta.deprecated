...
class GethIPC extends GethEmitter_1.default {
    ...
    _start() {
        this.registerListener(channels_1.default.server.geth.startService, (event, data) => {
            if (geth_connector_1.GethConnector.getInstance().serviceStatus.process) {
                this.fireEvent(channels_1.default.client.geth.startService, responses_1.gethResponse({}, { message: 'Service is already started.' }), event);
                return null;
            }
